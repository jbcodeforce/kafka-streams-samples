...
Address how to use the Kafka Streams API to implement different interesting use cases.
...
* [See this note in refarch-eda](https://ibm-cloud-architecture.github.io/refarch-eda/technology/kafka-streams/)
* [Product documentation](https://kafka.apache.org/documentation/streams/)
* [Quarkus Kafka Streams guide](https://quarkus.io/guides/kafka-streams)

## Lab 1: WordCount

This is based on the Apache Kafka Streams first app. See this folder [kstream-first](/kstream-first) in current repo with instructions in readme to run it locally.

## Lab 2: using test driver

Documentation in [EDA use case - lab 0](https://ibm-cloud-architecture.github.io/refarch-eda/use-cases/kafka-streams/lab-0/)

Code source is in [kstream-lab0 folder of eda-kstreams-labs repo](https://github.com/ibm-cloud-architecture/eda-kstreams-labs/tree/main/kstream-lab0)

## Lab 3: load reference data from topic

This is a simple example of loading some reference data from stream into a Ktable for lookup. It uses a persistent state store.

Code source is in [LoadKtableFromTopic folder of eda-kstreams-labs repo](https://github.com/ibm-cloud-architecture/eda-kstreams-labs/tree/main/LoadKtableFromTopic)

## Lab 4: item inventory or store inventory

Code is [refarch-eda-store-inventory](https://github.com/ibm-cloud-architecture/refarch-eda-store-inventory) and [refarch-eda-item-inventory](https://github.com/ibm-cloud-architecture/refarch-eda-item-inventory).

Main concepts:

* Use Custom Serdes on event to proceed based on JSONserdes that use jackson object mapper.
...
* Topologies are similar in both aggregate and  using the map and aggregate functions
...
[my samples](https://github.com/jbcodeforce/kafka-streams-samples)
